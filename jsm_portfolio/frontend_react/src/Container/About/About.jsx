            ...
            <div className="row">
              <div className="col-6  desc">
                ...
                <p>
                  ...
                  both remotely and in-person. Our Diverse team is well versed
          ...
          <div className="container">
            <div className="row rev">
              ...
              <div className="col-6 desc">
                ...
                <p>
                  We have build a team of the best developers and engineers in
                  the world to solve even the most complex of problems. Our
